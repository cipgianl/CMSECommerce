...
[Area("Admin")]
[Authorize("Admin")]
public class ProductsController(DataContext context, IWebHostEnvironment webHostEnvironment): Controller
{
    ...
    public async Task<IActionResult> Index(int categoryId = 0, int p = 1)
    {
        ...
        var productByCategory = _context.Products.Where(x => x.CategoryId == categoryId);
    ...
    public async Task<IActionResult> Create(Product product)
    {
        ...
        // Personalizza i messaggi di errore in caso di invalidità sulla chiave indicata
        CustomMessageInValidModelState.DecimalMessageError("Price", ModelState);
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        {
            // Elimina l'eventuale immagine del prodotto
            if (!string.Equals(product.Image, "noimage.png"))
            {
            ...
            // Elimina l'eventuale Galleria Immagini
